...
namespace PanGu.Framework
{
    ...
    public class IOHelper
    {
        ...
        {
            string sys = System.IO.Path.DirectorySeparatorChar.ToString();
            string web = @"/";//web的分隔符
        ...
        {
            WriteLog(InfoStr, AppDomain.CurrentDomain.BaseDirectory + System.IO.Path.Combine("App_Data", "Log"));
        }
        /// <summary>
        /// 写log(自动时间log)
        /// </summary>
        ...
        public static void WriteLog(string InfoStr, string DirPath, Encoding encoding)
        {
            ...
            try
            {
                ...
                string filepath = logPath + System.IO.Path.DirectorySeparatorChar + "log_" + DateTime.Now.ToString("yyyyMMddHH") + ".txt";
